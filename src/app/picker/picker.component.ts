...
export class PickerComponent implements OnInit {
  ...
  textToShow= "Lottery scheduling je probabilistički algoritam za dodeljivanje procesa u operativnom sistemu. \n"
